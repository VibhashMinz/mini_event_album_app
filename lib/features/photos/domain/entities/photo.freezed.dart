...
mixin _$Photo {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, albumId, url, liked);

  @override
  String toString() {
    return 'Photo(id: $id, albumId: $albumId, url: $url, liked: $liked)';
  }
}
...
abstract mixin class $PhotoCopyWith<$Res> {
  factory $PhotoCopyWith(Photo value, $Res Function(Photo) _then) =
      _$PhotoCopyWithImpl;
  @useResult
  $Res call({String id, String albumId, String url, bool liked});
}
